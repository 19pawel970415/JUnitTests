...
class PersonGradesTest {
    ...
    private static final Person PERSON_A = new Person("Mr", "Andrzej", "Nowak");
    private static final Person PERSON_B = new Person("Ms", "Ala", "Nowak");
